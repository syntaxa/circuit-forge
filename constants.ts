...
export const SEED_EXERCISES: Exercise[] = [
  ...
  { 
    ...
    difficulty: Difficulty.MEDIUM, 
    biSided: false,
    steps: '1. Сделайте широкий прыжок в правую сторону.\n2. Приземлитесь на правую ногу в полуприсед.\n3. Коснитесь пола левой рукой перед собой.\n4. Сразу же сделайте прыжок влево и коснитесь пола правой рукой. \n5. Старайтесь чтобы не было паузы в позиции "ноги вместе". \n6. В момент прыжка делайте максимальное усилие согнутой ногой.'
  },
  {
    id: '63',
    name: 'Drop And Touch',
    description: 'Прыжки ноги врозь — присед и касание пола поочерёдно каждой рукой.',
    muscleGroup: MuscleGroup.LEGS,
    difficulty: Difficulty.MEDIUM,
    biSided: false,
    steps: '1. Ноги вместе.\n2. Прыжком расставить ноги шире плеч.\n3. Присесть и коснуться пола одной рукой.\n4. Прыжок — ноги вместе.\n5. Повтор другой рукой.\n Старайтесь чтобы не было паузы в позиции "ноги вместе"'
  },
  { 
    id: '64', 
    name: 'Skater', 
    ...
    difficulty: Difficulty.MEDIUM, 
    biSided: false,
    steps: '1. Сделайте прыжок в сторону на правую ногу.\n2. Левую ногу заведите назад за правую по диагонали, не касаясь ею пола.\n3. Слегка наклоните корпус вперед для баланса.\n4. Повторите прыжок в левую сторону, меняя опорную ногу. \n5. Концентрируйтесь не на высоте пррыжка, а на горизонтальной скорости'
  },
  { 
    id: '65', 
    name: 'Lunge Touch And Kick', 
    description: 'Выпад назад с касанием пола рукой, затем подъем и удар ногой вперед.', 
    muscleGroup: MuscleGroup.LEGS, 
    difficulty: Difficulty.MEDIUM, 
    biSided: true,
    steps: '1. Сделайте глубокий выпад назад и коснитесь коленом пола.\n2. Коснитесь пола рукой со стороны передней ноги.\n3. Встаньте и нанесите резкий удар (кик) вперед ногой, которая стояла на месте.\n4. Снова вернитесь в выпад назад.'
  },
  { 
    id: '66', 
  ...
  { 
    ...
    description: 'Быстрые прыжки из стороны в сторону', 
    muscleGroup: MuscleGroup.LEGS, 
    difficulty: Difficulty.MEDIUM, 
    biSided: false,
    steps: '1. Поставьте стопы вместе. \n2. Согните одну ногу в колене и сделайте прыжок в сторону. \n3. Сделайте прыжок в другую сторону и поменяйте ноги местами. \n4. Повторите, сосредоточившись на горизонтальной скорости, а не на высоте прыжка.'
  },
  { 
    id: '68', 
  ...
  { 
    id: '69', 
    name: 'Power Lunge Jump', 
    description: 'Из выпада назад — взрывной прыжок вверх с подъёмом колена задней ноги к груди. Задняя нога может слегка опираться.', 
    muscleGroup: MuscleGroup.LEGS, 
    difficulty: Difficulty.HARD, 
    biSided: true,
    steps: '1. Примите положение выпада: одна нога впереди, другая сзади (можно слегка опираться на носок).\n2. Опуститесь в присед, сохраняя выпад.\n3. Взрывным движением выпрыгните вверх.\n4. В полёте подтяните колено задней ноги к груди.\n5. Мягко приземлитесь и повторите.'
  },
  { 
    id: '70', 
  ...
  { 
    ...
    difficulty: Difficulty.MEDIUM, 
    biSided: false,
    steps: '1. Встаньте в боксерскую стойку.\n2. Наносите удары вперед по воображаемой цели поочерёдно каждой рукой.\n3. Полностью выпрямляйте руку и быстро возвращайте к лицу.\n4. Удары должны быть короткими и быстрыми.'
  },
  { 
    id: '17', 
  ...
  { 
    ...
    difficulty: Difficulty.MEDIUM, 
    biSided: false,
    steps: '1. Сядьте на пол, ноги согнуты в коленях, отклонитесь назад, ноги оторвите от пола.\n2. Поворачивайте корпус вправо и влево.\n3. Руки в замке вытянуты перед собой и следуют за корпусом.\n4. Ноги должны оставаться неподвижными.'
  },
  { 
    id: '29', 
    name: 'Reverse Crunch', 
  ...
  { 
    ...
    difficulty: Difficulty.MEDIUM, 
    biSided: true,
    steps: '1. Встаньте в боковую планку на прямой руке.\n2. Вторая рука направлена вверх.\n3. Тело — ровная линия.\n4. Поднимите ногу, находящуюся сверху, максимально высоко.  \n5. Удерживайте статику. \n6. Поменяйте руку и ногу.'
  },
  { 
    id: '81', 
    name: 'Plank', 
  ...
  { 
    id: '82', 
    name: 'Crunch And Hug', 
    description: 'Скручивание с подтягиванием коленей и обниманием их руками.', 
    muscleGroup: MuscleGroup.ABS, 
    difficulty: Difficulty.MEDIUM, 
    biSided: false,
    steps: '1. Лягте на спину на пол, ноги прямые, руки вытянуты за головой.\n2. Скручивание: подтяните колени к груди.\n3. Руки обнимают колени.\n4. Плавно вернитесь в исходное положение.'
  },
  { 
    id: '83', 
    name: 'Reverse Plank', 
  ...
  { 
    id: '84', 
    name: 'Scissor Kicks', 
    description: 'Горизонтальные скрещивания прямых ног лежа на спине.',
    muscleGroup: MuscleGroup.ABS, 
    difficulty: Difficulty.MEDIUM, 
    biSided: false,
    steps: '1. Лягте на спину, руки вдоль корпуса или под таз для поддержки.\n2. Поднимите прямые ноги на 10–20 см от пола, слегка напрягите пресс.\n3. Разведите ноги в стороны, затем скрестите их горизонтально: одна нога сверху, другая снизу.\n4. Повторяйте: чередуйте, чтобы левая и правая ноги оказывались сверху.\n5. На протяжении всего упражнения ноги и поясница не должны касаться пола. Пресс напряжён.'
  },
  { 
    id: '85', 
    name: 'Side Plank', 
  ...
  { 
    ...
    description: 'Отжимание и одновременный подъем противоположной руки и ноги в верхней точке.', 
    muscleGroup: MuscleGroup.CHEST, 
    difficulty: Difficulty.HARD, 
    biSided: false,
    steps: '1. Сделайте отжимание.\n2. Вверху поднимите правую руку и левую ногу.\n3. Удержите баланс.\n4. Верните руку и ногу в исходное положение. \n5. Снова отжимание и смена сторон.'
  },
  { 
    id: '75', 
  ...
  { 
    id: '89', 
    name: 'Pike Push-Up', 
    description: 'Отжимания уголком, акцентирующие максимальную нагрузку на передние и средние дельты.', 
    muscleGroup: MuscleGroup.SHOULDERS, 
    difficulty: Difficulty.MEDIUM, 
    biSided: false,
    steps: '1. Примите упор лежа, затем подойдите ногами к рукам, поднимая таз высоко вверх.\n2. Тело должно образовывать перевернутую букву V.\n3. Сгибайте руки, опуская макушку головы к полу чуть впереди ладоней.\n4. Мощно выжмите себя вверх в исходное положение.'
  },
  { 
    id: '90', 
    name: 'Wall Walk', 
    description: 'Зашагивания ногами на стену из упора лежа до стойки на руках и обратно.', 
    muscleGroup: MuscleGroup.SHOULDERS, 
    difficulty: Difficulty.HARD, 
    biSided: false,
    steps: '1. Примите упор лежа, пятки упираются в стену.\n2. Начните переступать ногами вверх по стене, одновременно "шагая" руками к ней.\n3. Подойдите руками максимально близко к стене (в идеале — грудью).\n4. Контролируемо спуститесь руками и ногами обратно в упор лежа.'
  },
  { 
    id: '91', 
    name: 'Shoulder Taps', 
    description: 'Поочередное касание плеч руками в планке для развития стабильности плечевого пояса.', 
    muscleGroup: MuscleGroup.SHOULDERS, 
    difficulty: Difficulty.MEDIUM, 
    biSided: false,
    steps: '1. Встаньте в планку на прямых руках, ноги поставьте чуть шире плеч для баланса.\n2. Оторвите правую руку от пола и коснитесь левого плеча.\n3. Верните руку на пол и коснитесь правого плеча левой рукой.\n4. Чередуйте стороны, стараясь не раскачивать таз.'
  },
  { 
    id: '92', 
    name: 'Elevated Shoulder Taps', 
    description: 'Касания плеч в упоре лежа с ногами на стуле.', 
    muscleGroup: MuscleGroup.SHOULDERS, 
    difficulty: Difficulty.HARD, 
    biSided: false,
    steps: '1. Примите упор лежа, поставив стопы на устойчивый стул.\n2. Перенесите вес на левую руку, а правой коснитесь левого плеча.\n3. Плавно верните руку и поменяйте сторону.\n4. Держите корпус напряженным, не прогибая поясницу.'
  },
  { 
    id: '93', 
    name: 'Wall Handstand Hold', 
    description: 'Статическое удержание стойки на руках у стены.', 
    muscleGroup: MuscleGroup.SHOULDERS, 
    difficulty: Difficulty.HARD, 
    biSided: false,
    steps: '1. Поставьте руки на пол в 15-20 см от стены.\n2. Закиньте ноги на стену махом или "зашагайте" по ней вверх.\n3. Вытянитесь в прямую линию, опираясь только на руки (пятки касаются стены).\n4. Удерживайте положение, активно давя ладонями в пол и напрягая плечи.'
  },
  { 
    id: '94', 
    name: 'Wall Handstand Push-Up', 
    description: 'Отжимания в вертикальной стойке на руках с опорой на стену.', 
    muscleGroup: MuscleGroup.SHOULDERS, 
    difficulty: Difficulty.HARD, 
    biSided: false,
    steps: '1. Встаньте в стойку на руках, опираясь пятками о стену.\n2. Медленно согните локти, опуская голову до легкого касания пола.\n3. Мощным усилием плеч и трицепсов выжмите себя вверх.\n4. Сохраняйте тело ровным, избегая сильного прогиба в спине.'
  },
  { 
    id: '95', 
    name: 'Dolphin Push-Up', 
    description: 'Динамичный переход из планки на предплечьях в позу дельфина с поднятым тазом.', 
    muscleGroup: MuscleGroup.SHOULDERS, 
    difficulty: Difficulty.MEDIUM, 
    biSided: false,
    steps: '1. Встаньте в классическую планку на локтях.\n2. На выдохе поднимите таз максимально вверх, слегка шагая ногами вперед.\n3. Сделайте паузу, чувствуя напряжение в плечах.\n4. Плавно вернитесь в исходную планку на предплечьях.'
  },
  { 
    id: '96', 
    name: 'Pike Toe Touch', 
    description: 'Переход из планки в позицию "горки" с касанием рукой противоположной стопы.', 
    muscleGroup: MuscleGroup.SHOULDERS, 
    difficulty: Difficulty.MEDIUM, 
    biSided: false,
    steps: '1. Встаньте в планку на прямых руках.\n2. На выдохе поднимите таз вверх (поза горки) и потянитесь правой рукой к левому носку.\n3. Вернитесь в прямую планку.\n4. Повторите движение левой рукой к правому носку.'
  },
  { 
    id: '97', 
    name: 'Table Face Pull', 
    description: 'Горизонтальная тяга под столом с акцентом на заднюю дельту.', 
    muscleGroup: MuscleGroup.SHOULDERS, 
    difficulty: Difficulty.HARD, 
    biSided: false,
    steps: '1. Лягте под крепкий стол, возьмитесь за край столешницы хватом шире плеч.\n2. Тело вытянуто в прямую линию, пятки упираются в пол.\n3. Подтяните тело вверх, направляя лицо к краю стола и разводя локти строго в стороны.\n4. Медленно и подконтрольно опуститесь вниз.'
  },
  { 
    id: '98', 
    name: 'Bear Crawl', 
    description: 'Динамическая "медвежья походка" для развития выносливости плеч и кора.', 
    muscleGroup: MuscleGroup.SHOULDERS, 
    difficulty: Difficulty.MEDIUM, 
    biSided: false,
    steps: '1. Встаньте на четвереньки, оторвите колени на пару сантиметров от пола.\n2. Сделайте шаг вперед одновременно правой рукой и левой ногой.\n3. Затем шагните левой рукой и правой ногой.\n4. Двигайтесь вперед (или вперед-назад), сохраняя спину параллельной полу.'
  },
  { 
    id: '99', 
    name: 'Plank Arm Reaches', 
    description: 'Поочередное вытягивание рук вперед из положения планки.', 
    muscleGroup: MuscleGroup.SHOULDERS, 
    difficulty: Difficulty.MEDIUM, 
    biSided: false,
    steps: '1. Примите упор лежа на прямых руках.\n2. Оторвите одну руку от пола и вытяните ее прямо перед собой параллельно полу.\n3. Удержите напряжение на секунду и верните руку обратно.\n4. Повторите другой рукой, не допуская скручивания корпуса.'
  },
  { 
    id: '100', 
    name: 'Crab Reach', 
    description: 'Подъем таза из положения сидя с вытягиванием одной руки за голову.', 
    muscleGroup: MuscleGroup.SHOULDERS, 
    difficulty: Difficulty.MEDIUM, 
    biSided: false,
    steps: '1. Сядьте на пол, упритесь руками сзади, ноги согнуты (поза краба).\n2. Оторвите таз от пола.\n3. Мощно вытолкните таз вверх, отрывая одну руку и вытягивая ее по диагонали назад за голову.\n4. Вернитесь в позу краба и смените сторону.'
  },
  { 
    id: '101', 
    name: 'Loaded Beast to Plank', 
    description: 'Взрывное движение из сгруппированной позиции в планку, нагружающее дельты.', 
    muscleGroup: MuscleGroup.SHOULDERS, 
    difficulty: Difficulty.MEDIUM, 
    biSided: false,
    steps: '1. Из упора лежа согните колени и отведите таз назад к пяткам (колени не касаются пола).\n2. Руки остаются вытянутыми далеко вперед.\n3. Резко вытолкните тело вперед, возвращаясь в прямую планку.\n4. Погасите инерцию за счет силы плеч и кора, затем повторите.'
  },
  { 
    id: '102', 
    name: 'Crab Walk', 
    description: 'Ходьба "крабиком" лицом вверх, активно задействующая передние дельты.', 
    muscleGroup: MuscleGroup.SHOULDERS, 
    difficulty: Difficulty.MEDIUM, 
    biSided: false,
    steps: '1. Сядьте на пол, согните ноги, упритесь руками сзади себя.\n2. Оторвите таз от пола.\n3. Перемещайтесь, синхронно переставляя разноименные руку и ногу.\n4. Держите таз на весу на протяжении всего подхода.'
  },
  { 
    id: '103', 
    name: 'Plank Push-Away', 
    description: 'Отталкивание корпуса назад из планки на локтях для проработки плеч.', 
    muscleGroup: MuscleGroup.SHOULDERS, 
    difficulty: Difficulty.MEDIUM, 
    biSided: false,
    steps: '1. Встаньте в планку на предплечьях.\n2. С помощью усилия плеч толкните тело назад, так чтобы плечи оказались далеко позади локтей.\n3. Удерживайте позицию 2-3 секунды, чувствуя напряжение.\n4. Вернитесь в классическую планку (плечи ровно над локтями).'
  }
];